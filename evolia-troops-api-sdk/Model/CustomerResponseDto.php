 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerResponseDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerResponseDto';
...
'missionAddress' => 'getMissionAddress'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['evoliaId'] === null) {
            $invalidProperties[] = "'evoliaId' can't be null";
        }
        ...
        if ($this->container['missionAddress'] === null) {
            $invalidProperties[] = "'missionAddress' can't be null";
        }
